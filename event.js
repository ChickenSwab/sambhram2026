...
var cards = [
  ...
  { id: 10, name: "BGMI", info: "BGMI", img: "./img/bgmi.png" },
  { id: 11, name: "Roast Riot", info: "Rap battle", img: "./img/rapbat.png" },
  { id: 12, name: "Fifa", info: "Fifa", img: "./img/fifa.png" },
  {
    id: 13,
    name: "The spotlight",
    info: "monologue",
  ...
  { id: 15, name: "Style Sync", info: "Duet Walk", img: "./img/stylesync.png" },
  {
    id: 16,
    name: "Beat storm",
  ...
  { id: 21, name: "Among Us", info: "Among Us", img: "./img/amongus.png" },
];
